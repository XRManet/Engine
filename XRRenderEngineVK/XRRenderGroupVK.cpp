...
XRInputLayoutVK const* XRRenderGroupVK::getInputLayout() const
{
	return static_cast<XRInputLayoutVK const*>(XRRenderGroup::getInputLayout());
}
...
bool XRRenderGroupVK::updateImpl()
{
