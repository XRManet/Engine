...
void internal_mtr_raw_event_tid_arg(const char* category, const char* name, char ph, void* id, int thread_id, mtr_arg_type arg_type, const char* arg_name, void* arg_value);
